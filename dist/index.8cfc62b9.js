...
function getTimeZones() {
    fetch("http://worldtimeapi.org/api/timezone").then(function(response) {
...
function userSelection(location) {
    fetch(`http://worldtimeapi.org/api/timezone/${location}`).then(function(response) {
        return response.json();
    }).then((data)=>{
...
},{}]},["2mNKm","6rimH"], "6rimH", "parcelRequiredfdb")
